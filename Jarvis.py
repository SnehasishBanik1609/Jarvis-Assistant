...
def screenshot():
    ...
    img.save('D://aptitude//screenshot.png')
    ...
    while True:
        ...
        #     youtube(takeCommand())
            ...
            if platform == "win32" or "darwin":
                speak('you are my master. you created me couple of days ago')
            ...
            if platform == "win32":
                os.startfile(
                    "C:\\Users\\sansk\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe")
